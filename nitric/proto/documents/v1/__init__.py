...
# sources: proto/documents/v1/documents.proto
...
class DocumentsStub(betterproto.ServiceStub):
    async def get(
        self,
        ...
        *,
        ...
        return await self._unary_unary(
            "/nitric.proto.documents.v1.Documents/Get",
    ...
    async def set(
        ...
        *,
        ...
        return await self._unary_unary(
            "/nitric.proto.documents.v1.Documents/Set",
    ...
    async def delete(
        ...
        *,
        ...
        return await self._unary_unary(
            "/nitric.proto.documents.v1.Documents/Delete",
    ...
    async def query(
        ...
        *,
        ...
        return await self._unary_unary(
            "/nitric.proto.documents.v1.Documents/Query",
    ...
    async def query_stream(
        ...
        *,
        ...
        async for response in self._unary_stream(
            "/nitric.proto.documents.v1.Documents/QueryStream",
...
class DocumentsBase(ServiceBase):
    async def get(
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/nitric.proto.documents.v1.Documents/Get": grpclib.const.Handler(
                self.__rpc_get,
                grpclib.const.Cardinality.UNARY_UNARY,
                DocumentGetRequest,
                DocumentGetResponse,
            ),
            "/nitric.proto.documents.v1.Documents/Set": grpclib.const.Handler(
                self.__rpc_set,
                grpclib.const.Cardinality.UNARY_UNARY,
                DocumentSetRequest,
                DocumentSetResponse,
            ),
            "/nitric.proto.documents.v1.Documents/Delete": grpclib.const.Handler(
                self.__rpc_delete,
                grpclib.const.Cardinality.UNARY_UNARY,
                DocumentDeleteRequest,
                DocumentDeleteResponse,
            ),
            "/nitric.proto.documents.v1.Documents/Query": grpclib.const.Handler(
                self.__rpc_query,
                grpclib.const.Cardinality.UNARY_UNARY,
                DocumentQueryRequest,
                DocumentQueryResponse,
            ),
            "/nitric.proto.documents.v1.Documents/QueryStream": grpclib.const.Handler(
