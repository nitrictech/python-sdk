...
class EventingClient(BaseClient):
    ...
    def publish(self, topic_name: str, payload: dict = None, payload_type: str = 'none',
                request_id: str = str(uuid.uuid4())) -> str:
        """
        Publishes an event/message to a topic, which can be subscribed to by other services.
        ...
        event = NitricEvent(requestId=request_id,
